...
class Navbar extends Component {
    ...
    render(){
        return (
            <div style={{position: `fixed`, width: `100%`, zIndex: `2`}} className={this.state.scrolled?"bg1":"bg2"}>
                        ...
                        <div>
                            <Link to='/'>
                                <div style={{float: `left`, margin: `0px`, padding: `0px`}}>
                                    ...
                                    <span className="clearcut" style={{color: this.state.scrolled?`#ccddef`:`black`}}>clearcut</span>
                                </div>
                            </Link>
                        </div>
                        <div className="right">
